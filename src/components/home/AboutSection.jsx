      ...
      <div className="max-w-7xl mx-auto px-3 md:px-6 lg:px-8">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
          ...
          >
            ...
            />
            <div className="absolute -bottom-8 -right-1 md:-right-4 lg:-right-8 bg-white rounded-2xl p-6 shadow-xl">
          ...
          >
            <div>
              ...
              <p className="text-xl text-gray-600 leading-relaxed mb-6">
                Fondée par Mr WOMGA ALBERT, FEIDEU SERVICES est une entreprise
                spécialisée dans les solutions technologiques pour l'éducation.
                Notre mission est de moderniser les établissements éducatifs
                avec des technologies innovantes.
              </p>
              <p className="text-lg text-gray-600 leading-relaxed">
                Nous nous engageons à fournir des services de qualité
                supérieure, un support technique réactif et des solutions
                personnalisées qui répondent aux défis spécifiques de chaque
                établissement.
              </p>
            </div>
